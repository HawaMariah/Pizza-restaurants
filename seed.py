...
def seed_data():
    with app.app_context():
        ...
        restaurant5 = Restaurant(name="Peppinos", address="Kenyatta road")
        ...
        db.session.add_all([restaurant1, restaurant2, restaurant3, restaurant4, restaurant5, pizza1, pizza2, pizza3, pizza4, restaurant_pizza1, restaurant_pizza2, restaurant_pizza3, restaurant_pizza4])
        db.session.commit()
